package com.app.me.androidweather;
...
public class Weather {
    ...
    //api key
    private static final String OPEN_WEATHER_MAP_API = "56361f709064bb7e1909792c18555f30";
        ...
        protected void onPostExecute(JSONObject json) {
            try {
                if(json != null){
                    ...
                    delegate.processFinish(city, description, temperature, humidity, updatedOn);
